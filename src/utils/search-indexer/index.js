...
export default class {
	...
	async createIndex(name, config) {
		return this.adapter.createIndex instanceof Function
			? this.adapter.createIndex(name, config)
			: null
	}
	...
	async removeIndex(name, config) {
		return this.adapter.removeIndex instanceof Function
			? this.adapter.removeIndex(name, config)
			: null
	}
	...
	async getIndex(name, config) {
		return this.adapter.getIndex instanceof Function
			? this.adapter.getIndex(name, config)
			: null
	}
	...
	async put(index, value, config) {
		return this.adapter.put instanceof Function
			? this.adapter.put(index, value, config)
			: null
	}
	...
	async update(index, value, config) {
		return this.adapter.put instanceof Function
			? this.adapter.update(index, value, config)
			: null
	}
	...
	async search(index, text, config) {
		return this.adapter.search instanceof Function
			? this.adapter.search(index, text, config)
			: null
	}
	...
	async remove(index, value, config) {
		return this.adapter.remove instanceof Function
			? this.adapter.remove(index, value, config)
			: null
	}
	...
	async buildIndex(index, data, config) {
		return this.adapter.remove instanceof Function
			? this.adapter.buildIndex(index, data, config)
			: null
	}
	...
	async getTotalCount(index, config) {
		return this.adapter.getTotalCount instanceof Function
			? this.adapter.getTotalCount(index, config)
			: null
	}
}
